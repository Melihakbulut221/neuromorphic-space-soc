...
hierarchy. That layout is
\textbf{not} the layout these deck numbers describe, and no timing,
power or fault-injection result in this paper has been re-measured on
it; Magic DRC has not been run on it either \\
\midrule
